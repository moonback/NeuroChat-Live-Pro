...
const PersonalityEditor: React.FC<PersonalityEditorProps> = ({ 
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in">
            <div 
                className="relative w-full max-w-lg mx-4 bg-[#0f0f19] border border-white/10 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
                style={{
            ...
            >
                ...
                <div className="p-6 border-t border-white/5 bg-black/20 flex justify-end gap-3">
                    ...
                    <button 
                        ...
                        disabled={isSaving}
                        className="px-6 py-2.5 rounded-xl text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-indigo-500/20 flex items-center gap-2"
                    >
                        {isSaving ? (
                            <>
